        ...
        <div className="w-full space-y-4 mb-12">
            <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="flex gap-2">
                    ...
                    {(selectedDiet || selectedCuisine || selectedType || query) && (
                        <button
                            onClick={handleClear}
            ...
            {/* Expanded Filters */}
            <div className={cn(
                "grid grid-cols-1 md:grid-cols-3 gap-6 overflow-hidden transition-all duration-500 ease-in-out bg-card border border-border rounded-[2.5rem] shadow-xl p-0 h-0 opacity-0",
